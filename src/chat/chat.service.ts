...
export class ChatService {
  ...
  async generateResponse(prompt: string): Promise<string> {
    try {
      ...
      // Note: System instructions are NOT set here. They should be set in the OpenAI Playground UI.
      ...
      // Initiate a run with the function tool available
                  ...
                  properties: {
                    ...
                    filter: {
                      ...
                      properties: {
                        ...
                        in_district_quota: { type: 'number', description: 'Number of seats for students in district' },
                        out_district_quota: { type: 'number', description: 'Number of seats for students outside district' },
                        in_district_applicants: { type: 'number', description: 'Number of applicants from within district' },
                        out_district_applicants: { type: 'number', description: 'Number of applicants from outside district' },
                        in_district_pass_rate: { type: 'number', description: 'Pass rate for in-district students' },
                        out_district_pass_rate: { type: 'number', description: 'Pass rate for out-of-district students' }
                      }
                    }
                  }
                }
